...
export default {
  ...
  // cacheDirectory:
  // "/private/var/folders/3l/qbmb8rgs52gdyt69jss0y6yh0000gn/T/jest_dx",
  ...
  // Force coverage collection from ignored files using an array
  // of glob patterns
  // forceCoverageMatch: [],
  ...
  // E.g. maxWorkers: 10% will use 10% of your CPU amount + 1 as
  ...
  // An array of regexp pattern strings that are matched
  // against all modules before the module loader will
